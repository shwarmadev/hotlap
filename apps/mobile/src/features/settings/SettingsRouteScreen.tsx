    ...
    <>
      ...
      <SettingsSection title="Server settings">
        ...
        <SettingsRow
          ...
          disabled={noServerTargets}
        />
        {/* Custom prompt shortcuts are only editable on environments whose
            server advertises the capability. */}
        {supportsCustomPrompts ? (
          <SettingsRow
            icon="text.bubble"
            label="Custom Prompts"
            target="SettingsCustomPrompts"
            disabled={noServerTargets}
          />
        ) : null}
        <SettingsRow
      ...
      <SettingsSection title="App">
        ...
        <SettingsRow icon="info.circle" label="About Hotlap" target="SettingsAbout" />
      </SettingsSection>
    </>
  );
}
