...
function ThreadHeader(
  ...
  const nativeRightItems = native.options.unstable_headerRightItems;
  const nativeOptions =
    nativeRightItems && transcriptHeaderItems.length > 0
      ? {
          ...native.options,
  ...
  return (
    <>
      <ScreenHeader
        ...
        optionsVersion={[props.gitControls.projectScripts, onCopyTranscript !== undefined]}
...
function ThreadRouteContent(
  ...
  const copyTranscript = useCallback(() => void handleCopyTranscript(), [handleCopyTranscript]);
...
<<<<<<< HEAD
      ...
      <ThreadHeader
        ...
        onCopyTranscript={supportsTranscriptExport ? copyTranscript : undefined}
      />
