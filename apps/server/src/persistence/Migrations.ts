...
// Upstream migrations added after the shared manifest was last extended.
const pendingUpstreamMigrations = [[53, "PullRequestFilesViewed"]] as const;

export const migrationManifest = [
  ...upstreamMigrationManifest,
  ...pendingUpstreamMigrations,
] as const;
